...
{
  [TestFixture, Timeout(100000)] public class Q21_30_Tests
  {
    ...
    [Test] public void Q26() { Assert.AreEqual(443839, Q21_30.q26(String.Empty)); }  
    [Test] public void Q27() { Assert.AreEqual("2783915460", Q21_30.q27(String.Empty)); }  
